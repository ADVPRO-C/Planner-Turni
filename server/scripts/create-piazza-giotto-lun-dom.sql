...
-- Piazza Giotto è attiva domenica (1) e lunedì (2)

-- Genera disponibilità per Piazza Giotto dal 23 luglio al 1 agosto 2025
-- Solo per domeniche e lunedì
...
SELECT 
    ...
    array_agg(DISTINCT TO_CHAR(disp.data, 'Day')) as giorni
