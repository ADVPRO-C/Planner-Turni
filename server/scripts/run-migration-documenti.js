...
async function runMigration() {
  try {
    console.log("🚀 Esecuzione migrazione: crea tabella documenti_autorizzazioni");
    await db.connect();
    ...
    if (tableExists) {
      console.log("ℹ️  La tabella documenti_autorizzazioni esiste già. Nessuna migrazione necessaria.");
      return;
    }
